        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    mime = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false),
                    content_provider = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    content_location = table.Column<string>(type: "TEXT", maxLength: 2048, nullable: true),
                    ...
                    content_version = table.Column<int>(type: "INTEGER", nullable: true),
                    content_created_utc = table.Column<string>(type: "TEXT", nullable: true),
                    content_mime = table.Column<string>(type: "TEXT", maxLength: 255, nullable: true),
                    ...
                    content_revision = table.Column<int>(type: "INTEGER", nullable: false),
                    created_utc = table.Column<string>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_files_filesystem_entities_filesystem_id",
                        column: x => x.filesystem_id,
                        principalTable: "filesystem_entities",
                        principalColumn: "id",
