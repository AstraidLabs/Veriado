...
internal sealed class FileSystemMonitoringService : IFileSystemMonitoringService, IAsyncDisposable, IDisposable
{
    ...
    public void Start(CancellationToken externalCancellationToken)
    {
        lock (_syncRoot)
        {
            ...
            // ��dn� Task.Run s tokenem � b�� to norm�ln� jako background Task
    ...
    public async ValueTask DisposeAsync()
    {
        ...
        // ukon��me kan�l � �ten� skon�� ChannelClosedException
        _eventChannel.Writer.TryComplete();

        // zru��me intern� token � kdo �ek� na delay / pause / maintenance, skon�� OCE
        ctsToCancel?.Cancel();
    ...
    private async Task ProcessEventsAsync(CancellationToken cancellationToken)
    {
        while (true)
        {
            try
            {
                ...
                // �teme bez tokenu; p�i shutdownu se kan�l zav�e a skon��me pomoc� ChannelClosedException
    ...
    // a DispatchSyncActionsAsync nech�v�m beze zm�ny � u� spr�vn� propaguj� cancellationToken.
